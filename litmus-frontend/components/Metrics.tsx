...
const metrics = [
  { label: "VRAM", sub: "Peak GPU memory allocated", to: 4699, decimals: 0, suffix: " MB", note: "reclaimed at INT4", dir: "lower" },
  { label: "Tokens / sec", sub: "Generation throughput", to: 54.22, decimals: 2, suffix: "", note: "higher is better", dir: "higher" },
  { label: "TTFT", sub: "Time to first token", to: 0.012, decimals: 3, suffix: "s", note: "lower is better", dir: "lower" },
  { label: "Perplexity", sub: "Linguistic degradation", to: 0.26, decimals: 2, suffix: " Δ", prefix: "+", note: "small is safe", dir: "lower" },
];
